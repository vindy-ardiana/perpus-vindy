...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <h3 class="text-2xl font-bold text-indigo-700">Konfirmasi Peminjaman</h3>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-indigo-100 overflow-hidden">
        ...
        @if ($peminjaman->count() == 0)
            <div class="text-center py-12 text-gray-500">
                Tidak ada pengajuan peminjaman yang menunggu konfirmasi.
            </div>
        @endif
    </div>

    <div>{{ $peminjaman->links('vendor.pagination.tailwind') }}</div>
</div>
